...
Author = 'Edgar Sanchez, @edmsanchez13, virtualcornerstone.com'
...
FunctionsToExport = 'Get-ESXInventory', 'Get-ESXIODevice', 'Get-ESXNetworking', 
               'Get-ESXStorage'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("VMware","PowerCLI","Inventory","vSphere","ESXi")

        # A URL to the license for this module.
         LicenseUri = "https://github.com/arielsanchezmora/vDocumentation/blob/master/LICENSE.txt"
